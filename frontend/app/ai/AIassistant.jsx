// ai/AIassistant.jsx
// converted SVG file using react-native-svg
import Svg, { Path } from "react-native-svg";

export default function AIassistant({ size = 40, color = "#096686" }) {
  return (
    <Svg
      width={size}
      height={size}
    ...
    >
      ...
      <Path d="M68.7,44.9c-6.6-0.7-12.9-1-19-1c-6.1,0-12.5,0.3-19,1h0c-2.2,0.2-3.8,2.2-3.5,4.3l2,19.4 
        ...
        M38.6,62.5c-1.6,0-2.8-1.6-2.8-3.7s1.3-3.7,2.8-3.7s2.8,1.6,2.8,3.7S40.2,62.5,38.6,62.5z 
        M55.3,66.6c0,0.2-0.1,0.4-0.2,0.5 
        ...
        M60.6,62.5c-1.6,0-2.8-1.6-2.8-3.7 
