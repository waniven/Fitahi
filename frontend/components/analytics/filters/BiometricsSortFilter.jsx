 ...
 * Dropdown filter button for sorting biometric logs by various criteria.
 */
export default function BiometricsSortFilter({ value = "date-desc", onChange, isOpen = false, onToggle }) {
